...
% delete('ToRemoteLabs.zip')
% zip('ToRemoteLabs',{'RL_TTS3_Controller_Blank.mat','RL_TTS3_Controller_Blank.slx'});
% s=dir('ToRemoteLabs.zip').bytes/1000
% % s=dir('ToRemoteLabs.zip')
% clearvars
% load('RL_TTS3_Controller_Blank.mat')
